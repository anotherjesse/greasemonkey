...
function GM_ScriptHeaders( filename ) {
...
GM_ScriptHeaders.prototype.get = function() {
  if (this.headers) return this.headers;
  var source = getContents(getScriptFileURI(this.filename));
  return this.headers = parseScriptHeaders(source);
}
